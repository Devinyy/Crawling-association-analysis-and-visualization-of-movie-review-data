...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.film_text.setGeometry(QtCore.QRect(20, 120, 641, 41))
        font = QtGui.QFont()
        font.setFamily("焦糖奶茶")
        font.setPointSize(20)
        ...
        self.spider_btn.setGeometry(QtCore.QRect(270, 180, 151, 41))
        font = QtGui.QFont()
        font.setFamily("焦糖奶茶")
...
"color:rgb(0,0,0);")
        ...
        self.title_2.setGeometry(QtCore.QRect(270, 480, 171, 21))
        font = QtGui.QFont()
        font.setFamily("焦糖奶茶")
        font.setPointSize(16)
        font.setBold(True)
        ...
        self.title_3.setGeometry(QtCore.QRect(200, 510, 321, 21))
        font = QtGui.QFont()
        font.setFamily("焦糖奶茶")
        ...
        self.show_spider_detail.setGeometry(QtCore.QRect(20, 540, 641, 131))
        ...
        self.progressBar.setGeometry(QtCore.QRect(20, 680, 651, 23))
        self.progressBar.setProperty("value", 24)
        self.progressBar.setObjectName("progressBar")
        self.choose_film = QtWidgets.QTextBrowser(self.get_imform_interface)
        self.choose_film.setGeometry(QtCore.QRect(20, 270, 641, 161))
        self.choose_film.setObjectName("choose_film")
        self.title_4 = QtWidgets.QLabel(self.get_imform_interface)
        self.title_4.setGeometry(QtCore.QRect(290, 240, 111, 21))
        font = QtGui.QFont()
        font.setFamily("焦糖奶茶")
        font.setPointSize(16)
        font.setBold(True)
        ...
        self.film_text_2 = QtWidgets.QLineEdit(self.get_imform_interface)
        self.film_text_2.setGeometry(QtCore.QRect(390, 440, 151, 31))
        font = QtGui.QFont()
        font.setFamily("焦糖奶茶")
        font.setPointSize(20)
        self.film_text_2.setFont(font)
        self.film_text_2.setText("")
        self.film_text_2.setObjectName("film_text_2")
        self.spider_btn_2 = QtWidgets.QPushButton(self.get_imform_interface)
        self.spider_btn_2.setGeometry(QtCore.QRect(560, 440, 101, 31))
        font = QtGui.QFont()
        font.setFamily("焦糖奶茶")
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.spider_btn_2.setFont(font)
        self.spider_btn_2.setStyleSheet("background:rgb(255, 85, 127);\n"
"border-radius:15px;\n"
"color:rgb(0,0,0);")
        self.spider_btn_2.setObjectName("spider_btn_2")
        self.title_5 = QtWidgets.QLabel(self.get_imform_interface)
        self.title_5.setGeometry(QtCore.QRect(20, 440, 351, 31))
        font = QtGui.QFont()
        font.setFamily("焦糖奶茶")
        font.setPointSize(16)
        font.setBold(True)
...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.spider_btn.setText(_translate("MainWindow", "搜索"))
        self.title_2.setText(_translate("MainWindow", "当前爬取进度"))
        self.title_3.setText(_translate("MainWindow", "（为防止豆瓣封禁账号，爬取速度较慢）"))
        self.title_4.setText(_translate("MainWindow", "搜索结果"))
        self.spider_btn_2.setText(_translate("MainWindow", "爬取"))
        self.title_5.setText(_translate("MainWindow", "请输入您想爬取的电影编号："))
